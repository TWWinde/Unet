...
def add_all_arguments(parser, train):
    ...
    if train:
        parser.add_argument('--im_saver', type=int, default=100, help='frequency of showing training results')
        ...
        parser.add_argument('--freq_save_loss', type=int, default=2500, help='frequency of loss save updates')
